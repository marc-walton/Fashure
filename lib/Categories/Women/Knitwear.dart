...
class _KnitwearWState extends State<KnitwearW> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
  ...
  WCardigans(){
    return  PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .where('Category',isEqualTo: 'WCardigans'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
  ...
  Tops(){
    return PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WKnitted Tops'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
  ...
  Bottoms(){
    return  PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WKnitted  Bottoms'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
  ...
  WSweaters(){
    return PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WSweaters'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                     ...
                     RotatedBox(quarterTurns:3,child: Text("Cardigans",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                     RotatedBox(quarterTurns:3,child: Text("Knitted Skirts",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                     RotatedBox(quarterTurns:3,child: Text("Knitted Tops",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                     RotatedBox(quarterTurns:3,child: Text("Knitted  Bottoms",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                     RotatedBox(quarterTurns:3,child: Text("Dresses",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                     RotatedBox(quarterTurns:3,child: Text("Sweaters",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
