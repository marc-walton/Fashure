...
class _JewelWState extends State<JewelW> {
              ...
              child: Scaffold(
                ...
                appBar:AppBar(
                  ...
                  bottom: TabBar(
                    ...
                    tabs:[
                      Text("Anklets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5,),),
                       Text("Bracelets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5,),),
                      Text("Body Jewellery",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
                      ...
                      Text("Earrings",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
