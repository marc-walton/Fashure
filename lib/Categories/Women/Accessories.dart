              ...
              appBar:AppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs:[
                    ...
                    Text("Baker Boy Hats",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5,),),
                    ...
                    Text("Fedora",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5,),),
...
//          bool isPostOwner = currentUserId == ownerId;
      ...
      query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
       ...
       .where('Category',isEqualTo: 'WBelts')
          ...
          .where('Category',isEqualTo: 'WSocks')
               ...
               appBar:AppBar(
                 ...
                 bottom: TabBar(
                   ...
                   tabs:[
                     ...
                     Text("Bridal & Wedding",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
                     ...
                     Text("Ties & Collars",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
