...
import 'package:fashow/user.dart';import 'package:fashow/progress.dart';
...
class ShoesW extends StatefulWidget {
  ...
  const ShoesW({Key key, this.selectedPage}) : super(key: key);
  @override
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                       ...
                       RotatedBox(quarterTurns:3,child: Text("Espadrilles",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       ...
                       RotatedBox(quarterTurns:3,child: Text("Mules",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Pumps",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Loafers",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Oxford Shoes",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Lace-Up Shoes",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
