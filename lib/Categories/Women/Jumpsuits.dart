...
class JumpsuitW extends StatefulWidget {
  final  int selectedPage;

  const JumpsuitW({Key key, this.selectedPage}) : super(key: key);
  @override
  _JumpsuitWState createState() => _JumpsuitWState();
}

class _JumpsuitWState extends State<JumpsuitW> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
  ...
  WJump(){
    return PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .where('Category',isEqualTo: 'WJumpsuits'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
  ...
  WPlaysuits(){
    return  PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WPlaysuits'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
  ...
  WBody(){
    return PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WBody Suits'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                      RotatedBox(quarterTurns:3,child: Text("Jumpsuits",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Playsuits",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Body Suits",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
