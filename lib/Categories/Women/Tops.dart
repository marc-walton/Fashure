...
class TopsW extends StatefulWidget {
  final  int selectedPage;

  const TopsW({Key key, this.selectedPage}) : super(key: key);
  @override
  _TopsWState createState() => _TopsWState();
}

class _TopsWState extends State<TopsW> {
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Women')
            .where('Category',isEqualTo: 'WTunics'),isLive:true,
