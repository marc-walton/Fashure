...
class WatchesW extends StatefulWidget {
  final  int selectedPage;

  const WatchesW({Key key, this.selectedPage}) : super(key: key);
  @override
  _WatchesWState createState() => _WatchesWState();
}

class _WatchesWState extends State<WatchesW> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                      RotatedBox(quarterTurns:3,child: Text("Chronograph Watches",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Analog Watches",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Sports & Smart Watches",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Hybrid",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
