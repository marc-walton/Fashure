...
class SneakersM extends StatefulWidget {
  final  int selectedPage;

  const SneakersM({Key key, this.selectedPage}) : super(key: key);

  @override
  _SneakersMState createState() => _SneakersMState();
}

class _SneakersMState extends State<SneakersM> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
