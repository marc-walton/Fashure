...
class Hats extends StatefulWidget {
  ...
  const Hats({Key key, this.selectedPage}) : super(key: key);
  @override
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                       ...
                       RotatedBox(quarterTurns:3,child: Text("Fedora & Trilbies",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
