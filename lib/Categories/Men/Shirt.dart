                  ...
                  bottom:  PreferredSize(
                    ...
                    child: Container(
                      ...
                      child: TabBar(
                        ...
                        tabs:[
                          RotatedBox(quarterTurns:3,child: Text("Casual Shirts",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                          RotatedBox(quarterTurns:3,child: Text("Formal Shirts",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                          ],
                      ),
                    ),
                  ),
