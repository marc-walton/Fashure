...
class TrackKB extends StatefulWidget {
  @override
  _TrackKBState createState() => _TrackKBState();
}

class _TrackKBState extends State<TrackKB> {
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            ...
            .where('Category',isEqualTo: 'KBTrousers')
    );
  }
  KBTops(){
    return  PaginateFirestore(
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Boys')
            .where('Category',isEqualTo: 'KBTTops')
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Boys')
            .where('Category',isEqualTo: 'KBTTrousers')
    );
  }
  @override
