...
class HatsKB extends StatefulWidget {
  final  int selectedPage;

  const HatsKB({Key key, this.selectedPage}) : super(key: key);
  @override
  _HatsKBState createState() => _HatsKBState();
}

class _HatsKBState extends State<HatsKB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("Balaclavas",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Knitted Hats",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Sun Hats",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      RotatedBox(quarterTurns:3,child: Text("Hat Sets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
