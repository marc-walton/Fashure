...
class KidswB extends StatefulWidget {
  final  int selectedPage;

  const KidswB({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidswBState createState() => _KidswBState();
}

class _KidswBState extends State<KidswB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
