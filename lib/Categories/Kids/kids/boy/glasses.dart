...
class EyeKB extends StatefulWidget {
  final  int selectedPage;

  const EyeKB({Key key, this.selectedPage}) : super(key: key);
  @override
  _EyeKBState createState() => _EyeKBState();
}

class _EyeKBState extends State<EyeKB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
