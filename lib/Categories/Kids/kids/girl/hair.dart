...
class HairKG extends StatefulWidget {
  final  int selectedPage;

  const HairKG({Key key, this.selectedPage}) : super(key: key);
  @override
  _HairKGState createState() => _HairKGState();
}

class _HairKGState extends State<HairKG> {
                  ...
                  bottom:  PreferredSize(
                    ...
                    child: Container(
                      ...
                      child: TabBar(
                        ...
                        tabs:[
                        RotatedBox(quarterTurns:3,child: Text("Hair Bands",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                        RotatedBox(quarterTurns:3,child: Text("Hair Clips",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                        ],
                      ),
                    ),
                  ),
