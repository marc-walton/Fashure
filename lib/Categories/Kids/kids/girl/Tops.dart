...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            ...
            .where('Category',isEqualTo: 'KGBlouses'),isLive:true,
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGPolo Shirts'),isLive:true,
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGShirts'),isLive:true,
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGT-shirts'),isLive:true,
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGCrop Tops'),isLive:true,
    );
  }
