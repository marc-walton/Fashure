...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            ...
            .where('Category',isEqualTo: 'KGCasual Shorts'),isLive:true,
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGDenim Shorts'),isLive:true,
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query:  FirebaseFirestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGShort Sets'),isLive:true,
               );
  }
              ...
              appBar:AppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs:[
                    ...
                    Text("Short sets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
                  ],
                ),
              ),
