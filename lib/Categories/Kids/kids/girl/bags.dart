...
class BagsKG extends StatefulWidget {
  final  int selectedPage;

  const BagsKG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BagsKGState createState() => _BagsKGState();
}

class _BagsKGState extends State<BagsKG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
