  ...
  return
    FutureBuilder<QuerySnapshot> (
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData) {
            return new ListView.builder(physics: NeverScrollableScrollPhysics(), physics: NeverScrollableScrollPhysics(), 
                shrinkWrap: true,
...
class EyeKG extends StatelessWidget {
  final  int selectedPage;

  const EyeKG({Key key, this.selectedPage}) : super(key: key);
  @override
