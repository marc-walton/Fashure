...
class EyeTB extends StatefulWidget {
  final  int selectedPage;

  const EyeTB({Key key, this.selectedPage}) : super(key: key);
  @override
  _EyeTBState createState() => _EyeTBState();
}

class _EyeTBState extends State<EyeTB> {
  String priceQuery = "0";
  String AQuery = "A0";
  String BQuery = "B0";
  String CQuery = "C0";
