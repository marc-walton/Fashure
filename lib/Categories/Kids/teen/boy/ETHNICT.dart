...
class TBEthnic extends StatefulWidget {
  final  int selectedPage;

  const TBEthnic({Key key, this.selectedPage}) : super(key: key);
  @override
  _TBEthnicState createState() => _TBEthnicState();
}

class _TBEthnicState extends State<TBEthnic> {
  String priceQuery = "0";
  String AQuery = "A0";
  String BQuery = "B0";
  String CQuery = "C0";
            ...
            child: Scaffold(
              appBar:AppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs:[
                    Text("Kurta Set",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5,),),
                    Text("Suit Sets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
