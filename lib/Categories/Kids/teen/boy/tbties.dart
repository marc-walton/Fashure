...
class TiesTB extends StatefulWidget {
  final  int selectedPage;

  const TiesTB({Key key, this.selectedPage}) : super(key: key);
  @override
  _TiesTBState createState() => _TiesTBState();
}

class _TiesTBState extends State<TiesTB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                    ...
                    child: Container(
                      ...
                      child: TabBar(
                        ...
                        tabs:[
                         ...
                         RotatedBox(quarterTurns:3,child: Text("Bow Ties",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                        ],
                      ),
                    ),
                  ),
