...
class KidswBT extends StatefulWidget {
  final  int selectedPage;

  const KidswBT({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidswBTState createState() => _KidswBTState();
}

class _KidswBTState extends State<KidswBT> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
    ...
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userProducts')
            ...
            .where('Gender',isEqualTo: 'Teen-Boys')
             .where('Category',isEqualTo: 'TBTops'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userProducts')
  ...
  TBShorts(){
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userProducts')
            ...
            .orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Boys')
            .where('Category',isEqualTo: 'TBShorts & Trunks'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userProducts')
            .orderBy('round',descending: true)
            .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("Shorts & Trunks",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
