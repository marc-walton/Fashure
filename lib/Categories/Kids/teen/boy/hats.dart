...
class HatsTB extends StatefulWidget {
  final  int selectedPage;

  const HatsTB({Key key, this.selectedPage}) : super(key: key);
  @override
  _HatsTBState createState() => _HatsTBState();
}

class _HatsTBState extends State<HatsTB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                     ...
                     RotatedBox(quarterTurns:3,child: Text("Knitted Hats/Beanie",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
