...
class EyeTG extends StatefulWidget {
  final  int selectedPage;

  const EyeTG({Key key, this.selectedPage}) : super(key: key);
  @override
  _EyeTGState createState() => _EyeTGState();
}

class _EyeTGState extends State<EyeTG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
