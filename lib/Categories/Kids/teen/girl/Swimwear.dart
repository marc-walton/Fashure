...
class _KidswGTState extends State<KidswGT> {
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            ...
            .where('Category',isEqualTo: 'TGSwimsuits')
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Girls')
            .where('Category',isEqualTo: 'TGDresses')
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Girls')
            .where('Category',isEqualTo: 'TGBikinis')
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Girls')
            .where('Category',isEqualTo: 'TGFootwear')
...
//          bool isPostOwner = currentUserId == ownerId;
        ...
        query: Firestore.instance.collectionGroup('userProducts').orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Girls')
            .where('Category',isEqualTo: 'TGAccessories')
            ...
            child: Scaffold(
              appBar:AppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs:[
                    Text("Swimsuits",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5,),),
                    Text("Dresses",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
                    Text("Bikinis",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 5),),
