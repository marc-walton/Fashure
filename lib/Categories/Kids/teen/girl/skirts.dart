...
class KidskGT extends StatefulWidget {
  final  int selectedPage;

  const KidskGT({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidskGTState createState() => _KidskGTState();
}

class _KidskGTState extends State<KidskGT> {
