...
class JumpsuitGT extends StatefulWidget {
  final  int selectedPage;

  const JumpsuitGT({Key key, this.selectedPage}) : super(key: key);
  @override
  _JumpsuitGTState createState() => _JumpsuitGTState();
}

class _JumpsuitGTState extends State<JumpsuitGT> {
    ...
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userProducts')
            ...
            .where('Gender',isEqualTo: 'Teen-Girls')
             .where('Category',isEqualTo: 'TGJumpsuits'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userProducts')
  ...
  TGPlaysuits(){
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userProducts')
            ...
            .orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Girls')
             .where('Category',isEqualTo: 'TGPlaysuits'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userProducts')
            .orderBy('round',descending: true)
            .orderBy('timestamp',descending: true)
