...
class HatsBG extends StatefulWidget {
  final  int selectedPage;

  const HatsBG({Key key, this.selectedPage}) : super(key: key);
  @override
  _HatsBGState createState() => _HatsBGState();
}

class _HatsBGState extends State<HatsBG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("HeadBands",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
