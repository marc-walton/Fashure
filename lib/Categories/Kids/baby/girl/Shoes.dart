...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .where('Category',isEqualTo: 'GGBoots'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGSlippers'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGSneakers'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGBallerinas'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGPre-walkers'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userProducts')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGSandals'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userProducts')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("Pre-walkers",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
