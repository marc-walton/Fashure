        ...
        if(imageUrls.length==images.length){
          ...
          if (currentUser.country == 'Europe'){
            ...
            productsRef
              ...
              "custom92":  int.tryParse(customController92.text) ?? 0,
              "custom102":  int.tryParse(customController102.text) ??0,
              "custom11usd": gbptousd1.toString() ?? "0",
              "custom11gbp":userprice1.toString() ?? "0",
              "custom11eur": gbptoeur1.toString() ?? "0",
              "custom11inr": gbptoinr1.toString() ?? "0",
              "custom21usd": gbptousd2.toString() ?? "0",
              "custom21gbp": userprice2.toString() ?? "0",
              "custom21eur":gbptoeur2.toString() ?? "0",
              "custom21inr": gbptoinr2.toString() ?? "0",
              "custom31usd": gbptousd3.toString() ?? "0",
              "custom31gbp": userprice3.toString() ?? "0",
              "custom31eur": gbptoeur3.toString() ?? "0",
              "custom31inr": gbptoinr3.toString() ?? "0",
              "custom41usd": gbptousd4.toString() ?? "0",
              "custom41gbp": userprice4.toString() ?? "0",
              "custom41eur": gbptoeur4.toString() ?? "0",
              "custom41inr": gbptoinr4.toString() ?? "0",
              "custom51usd": gbptousd5.toString() ?? "0",
              "custom51gbp": userprice5.toString() ?? "0",
              "custom51eur": gbptoeur5.toString() ?? "0",
              "custom51inr": gbptoinr5.toString() ?? "0",
              "custom61usd": gbptousd6.toString() ?? "0",
              "custom61gbp": userprice6.toString() ?? "0",
              "custom61eur": gbptoeur6.toString() ?? "0",
              "custom61inr": gbptoinr6.toString() ?? "0",
              "custom71usd": gbptousd7.toString() ?? "0",
              "custom71gbp": userprice7.toString() ?? "0",
              "custom71eur": gbptoeur7.toString() ?? "0",
              "custom71inr": gbptoinr7.toString() ?? "0",
              "custom81usd": gbptousd8.toString() ?? "0",
              "custom81gbp": userprice8.toString() ?? "0",
              "custom81eur": gbptoeur8.toString() ?? "0",
              "custom81inr": gbptoinr8.toString() ?? "0",
              "custom91usd": gbptousd9.toString() ?? "0",
              "custom91gbp": userprice9.toString() ?? "0",
              "custom91eur": gbptoeur9.toString() ?? "0",
              "custom91inr": gbptoinr9.toString() ?? "0",
              "custom101usd": gbptousd10.toString() ?? "0",
              "custom101gbp": userprice10.toString() ?? "0",
              "custom101eur": gbptoeur10.toString() ?? "0",
              "custom101inr": gbptoinr10.toString() ?? "0",
              "shipcostusd": gbptousd11.toString() ?? "0",
              "shipcostgbp": userprice11.toString() ?? "0",
              "shipcosteur": gbptoeur11.toString() ?? "0",
              "shipcostinr": gbptoinr11.toString() ?? "0",
              "shipcostinternusd": gbptousd12.toString() ?? "0",
              "shipcostinterngbp": userprice12.toString() ?? "0",
              "shipcostinterneur": gbptoeur12.toString() ?? "0",
              "shipcostinterninr": gbptoinr12.toString() ?? "0",
            ...
            productsRef
              ...
              "custom92":  int.tryParse(customController92.text) ?? 0,
              "custom102":  int.tryParse(customController102.text) ??0,
              "custom11usd":userprice1.toString() ?? "0",
              "custom11gbp": usdtogbp1.toString() ?? "0",
              "custom11eur": usdtoeur1.toString() ?? "0",
              "custom11inr": usdtoinr1.toString() ?? "0",
              "custom21usd":userprice2.toString() ?? "0",
              "custom21gbp": usdtogbp2.toString() ?? "0",
              "custom21eur": usdtoeur2.toString() ?? "0",
              "custom21inr": usdtoinr2.toString() ?? "0",
              "custom31usd":userprice3.toString() ?? "0",
              "custom31gbp": usdtogbp3.toString() ?? "0",
              "custom31eur": usdtoeur3.toString() ?? "0",
              "custom31inr": usdtoinr3.toString() ?? "0",
              "custom41usd":userprice4.toString() ?? "0",
              "custom41gbp": usdtogbp4.toString() ?? "0",
              "custom41eur": usdtoeur4.toString() ?? "0",
              "custom41inr": usdtoinr4.toString() ?? "0",
              "custom51usd":userprice5.toString() ?? "0",
              "custom51gbp": usdtogbp5.toString() ?? "0",
              "custom51eur": usdtoeur5.toString() ?? "0",
              "custom51inr": usdtoinr5.toString() ?? "0",
              "custom61usd":userprice6.toString() ?? "0",
              "custom61gbp": usdtogbp6.toString() ?? "0",
              "custom61eur": usdtoeur6.toString() ?? "0",
              "custom61inr": usdtoinr6.toString() ?? "0",
              "custom71usd":userprice7.toString() ?? "0",
              "custom71gbp": usdtogbp7.toString() ?? "0",
              "custom71eur": usdtoeur7.toString() ?? "0",
              "custom71inr": usdtoinr7.toString() ?? "0",
              "custom81usd":userprice8.toString() ?? "0",
              "custom81gbp": usdtogbp8.toString() ?? "0",
              "custom81eur": usdtoeur8.toString() ?? "0",
              "custom81inr": usdtoinr8.toString() ?? "0",
              "custom91usd":userprice9.toString() ?? "0",
              "custom91gbp": usdtogbp9.toString() ?? "0",
              "custom91eur": usdtoeur9.toString() ?? "0",
              "custom91inr": usdtoinr9.toString() ?? "0",
              "custom101usd":userprice10.toString() ?? "0",
              "custom101gbp": usdtogbp10.toString() ?? "0",
              "custom101eur": usdtoeur10.toString() ?? "0",
              "custom101inr": usdtoinr10.toString() ?? "0",
              "shipcostusd":userprice11.toString() ?? "0",
              "shipcostgbp": usdtogbp11.toString() ?? "0",
              "shipcosteur": usdtoeur11.toString() ?? "0",
              "shipcostinr": usdtoinr11.toString() ?? "0",
              "shipcostinternusd":userprice12.toString() ?? "0",
              "shipcostinterngbp": usdtogbp12.toString() ?? "0",
              "shipcostinterneur": usdtoeur12.toString() ?? "0",
              "shipcostinterninr": usdtoinr12.toString() ?? "0",
            ...
            productsRef
              ...
              "custom92":  int.tryParse(customController92.text) ?? 0,
              "custom102":  int.tryParse(customController102.text) ??0,
              "custom11usd": inrtousd1.toString() ?? "0",
              "custom11gbp": inrtogbp1.toString() ?? "0",
              "custom11eur": inrtoeur1.toString() ?? "0",
              "custom11inr": userprice1.toString() ?? "0",
              "custom21usd": inrtousd2.toString() ?? "0",
              "custom21gbp": inrtogbp2.toString() ?? "0",
              "custom21eur": inrtoeur2.toString() ?? "0",
              "custom21inr": userprice2.toString() ?? "0",
              "custom31usd": inrtousd3.toString() ?? "0",
              "custom31gbp": inrtogbp3.toString() ?? "0",
              "custom31eur": inrtoeur3.toString() ?? "0",
              "custom31inr": userprice3.toString() ?? "0",
              "custom41usd": inrtousd4.toString() ?? "0",
              "custom41gbp": inrtogbp4.toString() ?? "0",
              "custom41eur": inrtoeur4.toString() ?? "0",
              "custom41inr": userprice4.toString() ?? "0",
              "custom51usd": inrtousd5.toString() ?? "0",
              "custom51gbp": inrtogbp5.toString() ?? "0",
              "custom51eur": inrtoeur5.toString() ?? "0",
              "custom51inr": userprice5.toString() ?? "0",
              "custom61usd": inrtousd6.toString() ?? "0",
              "custom61gbp": inrtogbp6.toString() ?? "0",
              "custom61eur": inrtoeur6.toString() ?? "0",
              "custom61inr": userprice6.toString() ?? "0",
              "custom71usd": inrtousd7.toString() ?? "0",
              "custom71gbp": inrtogbp7.toString() ?? "0",
              "custom71eur": inrtoeur7.toString() ?? "0",
              "custom71inr": userprice7.toString() ?? "0",
              "custom81usd": inrtousd8.toString() ?? "0",
              "custom81gbp": inrtogbp8.toString() ?? "0",
              "custom81eur": inrtoeur8.toString() ?? "0",
              "custom81inr": userprice8.toString() ?? "0",
              "custom91usd": inrtousd9.toString() ?? "0",
              "custom91gbp": inrtogbp9.toString() ?? "0",
              "custom91eur": inrtoeur9.toString() ?? "0",
              "custom91inr": userprice9.toString() ?? "0",
              "custom101usd": inrtousd10.toString() ?? "0",
              "custom101gbp": inrtogbp10.toString() ?? "0",
              "custom101eur": inrtoeur10.toString() ?? "0",
              "custom101inr": userprice10.toString() ?? "0",
              "shipcostusd": inrtousd11.toString() ?? "0",
              "shipcostgbp": inrtogbp11.toString() ?? "0",
              "shipcosteur": inrtoeur11.toString() ?? "0",
              "shipcostinr": userprice11.toString() ?? "0",
              "shipcostinternusd": inrtousd12.toString() ?? "0",
              "shipcostinterngbp": inrtogbp12.toString() ?? "0",
              "shipcostinterneur": inrtoeur12.toString() ?? "0",
              "shipcostinterninr": userprice12.toString() ?? "0",
