                  ...
                  child: TabBar(
                    ...
                    tabs: <Widget>[
                      FittedBox(
                        ...
                        child: Row(
                          children: [
                            TranslatedText('Notifications',to:'${currentUser.language}'),
                                 badgescount(),
                          ],
                        ),
                      ),
                      FittedBox(
                        ...
                        child: Row(
                          children:[
                          TranslatedText('Chats',to:'${currentUser.language}'),
                            // badgescountmessage(),
                          ],
                        ),
                      ),
                      FittedBox(
                        ...
                        child: Row(
                          children: [
                            TranslatedText('Settings',to:'${currentUser.language}'),
                ...
                Stack(
                  children: [
                    OutlineButton(
                     ...
                     child: TranslatedText('Dashboard',to:'${currentUser.language}',
