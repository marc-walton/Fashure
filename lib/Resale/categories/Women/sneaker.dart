...
class SneakersW extends StatefulWidget {
  final  int selectedPage;

  const SneakersW({Key key, this.selectedPage}) : super(key: key);
  @override
  _SneakersWState createState() => _SneakersWState();
}

class _SneakersWState extends State<SneakersW> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
bool isLiked;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .where('Category',isEqualTo: 'WHigh - Tops'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
...
bool isLiked;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WLow - Tops'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
bool isLiked;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WHigh Heel'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
bool isLiked;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Women')
          .where('Category',isEqualTo: 'WSlip-On Sneakers'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                       RotatedBox(quarterTurns:3,child: Text("High - Tops",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal *3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Low - Tops",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("High Heel",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Slip-On Sneakers",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
