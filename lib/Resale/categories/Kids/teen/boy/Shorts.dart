...
class KidshBT extends StatefulWidget {
  final  int selectedPage;

  const KidshBT({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidshBTState createState() => _KidshBTState();
}

class _KidshBTState extends State< KidshBT> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
bool isLiked;
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .where('Gender',isEqualTo: 'Teen-Boys')
             .where('Category',isEqualTo: 'TBCasual Shorts'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
