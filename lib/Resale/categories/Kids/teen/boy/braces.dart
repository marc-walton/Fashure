...
class BracesTB extends StatefulWidget {
  final  int selectedPage;

  const BracesTB({Key key, this.selectedPage}) : super(key: key);
  @override
  _BracesTBState createState() => _BracesTBState();
}

class _BracesTBState extends State<BracesTB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
