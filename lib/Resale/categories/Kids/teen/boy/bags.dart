...
class BagsTB extends StatefulWidget {
  final  int selectedPage;

  const BagsTB({Key key, this.selectedPage}) : super(key: key);
  @override
  _BagsTBState createState() => _BagsTBState();
}

class _BagsTBState extends State<BagsTB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
