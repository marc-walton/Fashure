...
class KidTB extends StatefulWidget {
  final  int selectedPage;

  const KidTB({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidTBState createState() => _KidTBState();
}

class _KidTBState extends State<KidTB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
bool isLiked;
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
           ...
           .where('Category',isEqualTo: 'TBCardigans'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
...
bool isLiked;
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Boys')
            .where('Category',isEqualTo: 'TBSweaters'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
            .orderBy('round',descending: true)
            .orderBy('timestamp',descending: true)
