...
class DenimBT extends StatefulWidget {
  final  int selectedPage;

  const DenimBT({Key key, this.selectedPage}) : super(key: key);
  @override
  _DenimBTState createState() => _DenimBTState();
}

class _DenimBTState extends State<DenimBT> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
