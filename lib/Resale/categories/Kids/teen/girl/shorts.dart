...
class KidshGT extends StatefulWidget {
  final  int selectedPage;

  const KidshGT({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidshGTState createState() => _KidshGTState();
}

class _KidshGTState extends State< KidshGT> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
//        showHeart = true;
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .where('Gender',isEqualTo: 'Teen-Girls')
             .where('Category',isEqualTo: 'TGCasual Shorts'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
