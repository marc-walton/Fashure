...
class BracesTG extends StatefulWidget {
  final  int selectedPage;

  const BracesTG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BracesTGState createState() => _BracesTGState();
}

class _BracesTGState extends State<BracesTG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
