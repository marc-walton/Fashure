...
class KidkGT extends StatefulWidget {
  final  int selectedPage;

  const KidkGT({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidkGTState createState() => _KidkGTState();
}

class _KidkGTState extends State<KidkGT> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
  ...
  TGCardigans(){
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userProducts')
            ...
            .where('Category',isEqualTo: 'TGCardigans'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userProducts')
  ...
  TGKnitted(){
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userProducts')
            ...
            .orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Teen-Girls')
            .where('Category',isEqualTo: 'TGKnitted Tops'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userProducts')
            .orderBy('round',descending: true)
            .orderBy('timestamp',descending: true)
