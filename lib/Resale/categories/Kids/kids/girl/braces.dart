...
class BracesKG extends StatefulWidget {
  final  int selectedPage;

  const BracesKG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BracesKGState createState() => _BracesKGState();
}

class _BracesKGState extends State<BracesKG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
