...
class KidkG extends StatefulWidget {
  final  int selectedPage;

  const KidkG({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidkGState createState() => _KidkGState();
}

class _KidkGState extends State<KidkG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
  ...
  KGCardigans(){
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .where('Category',isEqualTo: 'KGCardigans'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
  ...
  KGKnitted(){
    return   PaginateFirestore(
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGKnitted Tops'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
            .orderBy('round',descending: true)
            .orderBy('timestamp',descending: true)
