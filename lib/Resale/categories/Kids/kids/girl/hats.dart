...
class HatsKG extends StatefulWidget {
  final  int selectedPage;

  const HatsKG({Key key, this.selectedPage}) : super(key: key);
  @override
  _HatsKGState createState() => _HatsKGState();
}

class _HatsKGState extends State<HatsKG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
