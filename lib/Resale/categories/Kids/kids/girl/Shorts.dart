...
class KidshG extends StatefulWidget {
  final  int selectedPage;

  const KidshG({Key key, this.selectedPage}) : super(key: key);
  @override
  _KidshGState createState() => _KidshGState();
}

class _KidshGState extends State< KidshG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
GestureDetector(
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .where('Category',isEqualTo: 'KGCasual Shorts'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
...
GestureDetector(
        ...
        FirebaseFirestore.instance.collectionGroup('userResale')
            ...
            .orderBy('timestamp',descending: true)
            .where('Gender',isEqualTo: 'Kids-Girls')
            .where('Category',isEqualTo: 'KGShort Sets'):
        priceQuery == "high"?
        FirebaseFirestore.instance.collectionGroup('userResale')
            .orderBy('round',descending: true)
            .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("Short sets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
