...
class KGEthnic extends StatefulWidget {
  final  int selectedPage;

  const KGEthnic({Key key, this.selectedPage}) : super(key: key);
  @override
  _KGEthnicState createState() => _KGEthnicState();
}

class _KGEthnicState extends State<KGEthnic> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                       ...
                       RotatedBox(quarterTurns:3,child: Text("Kurta Sets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
