...
class TiesKB extends StatefulWidget {
  final  int selectedPage;

  const TiesKB({Key key, this.selectedPage}) : super(key: key);
  @override
  _TiesKBState createState() => _TiesKBState();
}

class _TiesKBState extends State<TiesKB> {
