...
import 'package:fashow/user.dart';import 'package:fashow/Categories/Kids/kids/boy/hats.dart';
...
class AccessKB extends StatefulWidget {
  ...
  const AccessKB({Key key, this.selectedPage}) : super(key: key);
  @override
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("Eyewear",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
