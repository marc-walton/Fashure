...
class BabykB extends StatefulWidget {
  final  int selectedPage;

  const BabykB({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabykBState createState() => _BabykBState();
}

class _BabykBState extends State<BabykB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .where('Category',isEqualTo: 'BBCardigans'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Boys')
          .where('Category',isEqualTo: 'BBSweaters'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
