...
class TiesBB extends StatefulWidget {
  final  int selectedPage;
  const TiesBB({Key key, this.selectedPage}) : super(key: key);
  @override
  _TiesBBState createState() => _TiesBBState();
}

class _TiesBBState extends State<TiesBB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
