...
class BabyshB extends StatefulWidget {
  final  int selectedPage;

  const BabyshB({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabyshBState createState() => _BabyshBState();
}

class _BabyshBState extends State<BabyshB> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
  ...
  BBCasual(){
    return  PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .where('Category',isEqualTo: 'BBCasual Shorts'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
  ...
  BBDenim(){
    return  PaginateFirestore(
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Boys')
          .where('Category',isEqualTo: 'BBDenim Shorts'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                       RotatedBox(quarterTurns:3,child: Text("Casual Shorts",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Denim Shorts",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal *3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Shorts sets",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal *3.4,))),
                      ],
                    ),
                  ),
                ),
