...
class BBEthnic extends StatefulWidget {
  ...
  const BBEthnic({Key key, this.selectedPage}) : super(key: key);
  @override
  _BBEthnicState createState() => _BBEthnicState();
}

class _BBEthnicState extends State<BBEthnic> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                  ...
                  bottom:  PreferredSize(
                    ...
                    child: Container(
                      ...
                      child: TabBar(
                        ...
                        tabs:[
                         RotatedBox(quarterTurns:3,child: Text("Kurta Set", style: TextStyle(
                            fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                         RotatedBox(quarterTurns:3,child: Text("Suit Sets", style: TextStyle(
                              fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                         RotatedBox(quarterTurns:3,child: Text("Kurta & Tops", style: TextStyle(
                              fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                         RotatedBox(quarterTurns:3,child: Text("Ethnic Bottoms", style: TextStyle(
                              fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                         RotatedBox(quarterTurns:3,child: Text("Indo Western & Fusion Wear", style: TextStyle(
                              fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                         RotatedBox(quarterTurns:3,child: Text("Sherwanis", style: TextStyle(
                              fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
