...
import 'package:fashow/user.dart';import 'package:fashow/Categories/Kids/baby/girl/hats.dart';

import 'package:currency_formatter/currency_formatter.dart';
import 'package:fashow/chatcached_image.dart';
import 'package:fashow/enum/Variables.dart';
class BabyAcG extends StatefulWidget {
  final  int selectedPage;

  const BabyAcG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabyAcGState createState() => _BabyAcGState();
}

class _BabyAcGState extends State<BabyAcG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
