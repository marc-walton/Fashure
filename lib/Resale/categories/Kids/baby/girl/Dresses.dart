...
class BabydrG extends StatefulWidget {
  final  int selectedPage;

  const BabydrG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabydrGState createState() => _BabydrGState();
}

class _BabydrGState extends State<BabydrG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
//        showHeart = true;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .where('Category',isEqualTo: 'GGCasual Dresses'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
...
//        showHeart = true;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGSParty Wear'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                      RotatedBox(quarterTurns:3,child: Text("Casual Dresses",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
