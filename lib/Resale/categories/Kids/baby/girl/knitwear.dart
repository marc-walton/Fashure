...
class BabykG extends StatefulWidget {
  final  int selectedPage;

  const BabykG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabykGState createState() => _BabykGState();
}

class _BabykGState extends State<BabykG> {
...
//        showHeart = true;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .where('Category',isEqualTo: 'GGCardigans'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
...
//        showHeart = true;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGSweaters'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
...
//        showHeart = true;
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .orderBy('timestamp',descending: true)
          .where('Gender',isEqualTo: 'Baby-Girls')
          .where('Category',isEqualTo: 'GGKnitted dresses'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
          .orderBy('round',descending: true)
          .orderBy('timestamp',descending: true)
                ...
                bottom:  PreferredSize(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      RotatedBox(quarterTurns:3,child: Text("Knitted dresses",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 3.4,))),
                      ],
                    ),
                  ),
                ),
