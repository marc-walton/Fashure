...
class BabyswG extends StatefulWidget {
  final  int selectedPage;

  const BabyswG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabyswGState createState() => _BabyswGState();
}

class _BabyswGState extends State<BabyswG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
...
GestureDetector(
      ...
      FirebaseFirestore.instance.collectionGroup('userResale')
          ...
          .where('Category',isEqualTo: 'GGSwimwear'):
      priceQuery == "high"?
      FirebaseFirestore.instance.collectionGroup('userResale')
