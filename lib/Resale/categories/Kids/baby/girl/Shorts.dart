...
class BabyshG extends StatefulWidget {
  final  int selectedPage;

  const BabyshG({Key key, this.selectedPage}) : super(key: key);
  @override
  _BabyshGState createState() => _BabyshGState();
}

class _BabyshGState extends State<BabyshG> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
