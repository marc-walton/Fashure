...
class SweaterM extends StatefulWidget {
  final  int selectedPage;

  const SweaterM({Key key, this.selectedPage}) : super(key: key);

  @override
  _SweaterMState createState() => _SweaterMState();
}

class _SweaterMState extends State<SweaterM> {
  void initState() {
    super.initState();
    priceQuery = "";
    sizeFilter = "";
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs:[
                       ...
                       RotatedBox(quarterTurns:3,child: Text("Sweatshirts",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal *3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Knitwear",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal *3.4,))),
                       RotatedBox(quarterTurns:3,child: Text("Hoodies",style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal *3.4,))),
